...
export default function SearchPage() {
  ...
  >
    ...
    <Paper sx={{  overflow: 'hidden', margin: '30px' , boxShadow: '0 2px 4px rgba(0,0,0,0.4)' ,maxWidth:'95%',marginInline:'auto'}}>
      <TableContainer sx={{ maxHeight: '440px',minHeight:'315px' }}>
